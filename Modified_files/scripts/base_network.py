...
def _set_lines_s_nom_from_linetypes(n):
    # Prevent unrealistic num_parallel values from OSM data
    n.lines["num_parallel"] = n.lines["num_parallel"].clip(upper=2.0)  # Added to avoid overestimation of s_nom for lines (2 circuits assumed max for small countries)
