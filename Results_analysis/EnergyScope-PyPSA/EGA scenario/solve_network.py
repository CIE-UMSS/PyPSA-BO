...
def CCGT_capacity_constraint(n):
    ...
    rhs = 865 #CCGT max potential MW based on EnergyScope limitation (378 first run and 359 fifth run)
...
def Oil_capacity_constraint(n):
    ...
    rhs = 0.14 #Diesel max potential MW based on EnergyScope limitation (625 first run and 577 fifth run)
...
def biomass_capacity_constraint(n):
    ...
    rhs = 1647 #Biomass potential MW based on EnergyScope limitation (757 first run and 1134 fifth run) 
...
def Wind_capacity_constraint(n):
    ...
    rhs = 1245 #Onshore wind max potential MW based on EnergyScope limitation (6632 first run and 2106 fifth run) 
...
def Solar_capacity_constraint(n):
    ...
    rhs = 5452 #Solar max potential MW based on EnergyScope limitation (7352 first run and 9454 fifth run) 
...
def biomass_operation_constraint(n):
    ...
    biomass_limit = 5915450 #MWh potential resources for biomass-based generation (1402940 first run) (5606002 fifth run)
    rhs = biomass_limit
...
def OCGT_operation_constraint(n):
    ...
    OCGT_limit = 16386 #MWh potential resources for gas-based generation (25143 first run) (22958 fifth run)
    rhs = OCGT_limit
...
def CCGT_operation_constraint(n):
    ...
    CCGT_limit = 3091706 #MWh potential resources for gas-based generation (156512 first run) (160344 fifth run)
    rhs = CCGT_limit
...
def oil_operation_constraint(n):
    ...
    oil_limit = 15 #MWh potential resources for gas-based generation (19078 first run) (26758 fifth run)
    rhs = oil_limit
...
def battery_operation_constraint(n):
    ...
    battery_limit = 6924 #MWh potential resources for battery storage based on EVs (8016 for 1st run) (8071 second run)
    rhs = battery_limit
